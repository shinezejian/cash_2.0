...
public class CashContactDAO {
    private Integer pkCashcontact;

    private Integer fkCash;
    ...
    public Integer getPkCashcontact() {
        return pkCashcontact;
    }

    public void setPkCashcontact(Integer pkCashcontact) {
        this.pkCashcontact = pkCashcontact;
    }

    public Integer getFkCash() {
        return fkCash;
    }

    public void setFkCash(Integer fkCash) {
        this.fkCash = fkCash;
    }
